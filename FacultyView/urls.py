...
urlpatterns = [
    ...
    path("class/attendance/<int:classId>/",views.faculty_view_attendance_export_form_id, name="faculty_view_attendance_export_form"),
    
    path("class/attendance/<str:action>/<int:year>/<int:month>/<int:day>/", views.faculty_view_attendance_export_all, name="faculty_view_attendance_export_id"),
    
    path("class/attendance/<int:classId>/<str:action>/<int:year>/<int:month>/<int:day>/", views.faculty_view_attendance_export_id, name="faculty_view_attendance_export_id"),
    path("class/attendance/<str:className>/<str:action>/<int:year>/<int:month>/<int:day>/", views.faculty_view_attendance_export_name, name="faculty_view_attendance_export_name"),
